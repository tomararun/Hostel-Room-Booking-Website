...
<head>
	...
	<title>Boys Hostel-1 Registration</title>
...
<input type="radio" value="1" name="foodstatus"> With Food(Rs 15000.00 Per Semester)
</div>
</div>	
...
<div class="form-group">
<label class="col-sm-2 control-label">Fee Recipt</label>
<div class="col-sm-8">
