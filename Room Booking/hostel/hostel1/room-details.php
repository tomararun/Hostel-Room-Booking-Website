...
<td><a href="javascript:void(0);"  onClick="popUpWindow('http://localhost/Rec/hostel/hostel1/full-profile.php?id=<?php echo $row->emailid;?>');" title="View Full Details">Print Data</a></td>
</tr>
<tr>
<td colspan="6"><b>Data & Time :<?php echo $row->postingDate;?></b></td>
</tr>
