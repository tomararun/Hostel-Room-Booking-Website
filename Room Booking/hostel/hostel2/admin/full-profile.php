...
$prefix = "";
$bd = mysqli_connect($mysqli_hostname, $mysqli_user, $mysql_password) or die("Could not connect database");
...
?>
    ...
    <tr>
      <td colspan="2" class="font">
        ...
        <?php echo ucfirst($row['lastName']); ?>'S <span class="font1"> information &raquo;</span>
      </td>
    </tr>
    <tr>
      <td colspan="2" class="font">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <div align="right">Reg Date : <span class="comb-value">
      ...
      <td colspan="2" class="font1">
        <table width="100%" border="0">
          <tr>
            ...
            <td class="comb-value1"><span class="comb-value">
                <?php echo $row['roomno']; ?>
              </span></td>
          </tr>
          <tr>
